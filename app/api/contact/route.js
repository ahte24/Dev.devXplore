...
export async function POST(req) {
	try {
		...
		const mailOptions = {
			...
			html: `
        <div style="font-family: 'Sora', Arial, 'Helvetica Neue', Helvetica, sans-serif; background-color: #000e0f; color: #f0f0f0; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
    ...
    <table style="width: 100%; margin-top: 20px; border-collapse: collapse; color: #f0f0f0;">
        <tr style="background-color: #1a1a1a; padding: 10px 0;">
