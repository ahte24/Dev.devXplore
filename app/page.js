												...
												<div className="w-full  flex flex-col gap-4">
													<div className="w-full  flex justify-center items-center z-20">
														<p className="text-[16px] text-[#649B9B] text-center">
															...
															meticulously considered for a seamless experience.
												...
												<div className="w-full  flex flex-col gap-4">
													<div className="w-full  flex justify-center items-center z-20">
														<p className="text-[16px] text-[#649B9B] text-center">
															...
															solutions that drive performance. Every aspect,
															from frontend to backend, is meticulously
															engineered for a seamless experience. Committed to
															quality.
														</p>
													</div>
													<button className="w-[90%] mx-auto h-[50px] bg-[#00171A] z-20 flex justify-center items-center border border-[#00393D] rounded-full text-[14px] text-[#E5FFFD]">
												...
												<div className="w-full  flex flex-col gap-4">
													<div className="w-full  flex justify-center items-center z-20">
														<p className="text-[16px] text-[#649B9B] text-center">
															...
															marketing strategies that boost your online
															presence. Every element, from SEO to social media,
															is meticulously planned for maximum impact.
															Committed to growth.
														</p>
													</div>
													<button className="w-[90%] mx-auto h-[50px] bg-[#00171A] z-20 flex justify-center items-center border border-[#00393D] rounded-full text-[14px] text-[#E5FFFD]">
												...
												<div className="w-full  flex flex-col gap-4">
													<div className="w-full  flex justify-center items-center z-20">
														<p className="text-[16px] text-[#649B9B] text-center">
															...
															consulting services that drive success. Every
															aspect, from strategy to execution, is
						...
						<div className="2xl:w-[45%] px-8 min-h-[400px] justify-center flex flex-col gap-5 ">
							<div className=" flex flex-col gap-8">
								...
								<p className="text-[#507C7C] text-[16px]">
									...
									websites that cater to your unique business needs. Our team of
									expert developers and designers work closely with you to
									transform your vision into a reality. Whether you need a
									sleek, user-friendly website or a robust, scalable mobile app,
									we have the skills and experience to deliver exceptional
									results.
								</p>
							</div>
							...
							<div className="w-[750px] h-[150px] flex justify-between items-center absolute top-[20px]">
								<div className="flex flex-col gap-4 h-full p-3 border-[#00393D] border rounded-3xl w-[350px] backdrop-filter backdrop-blur-md opacity-65 bg-gradient-to-tl from-[#001a1b] to-[#00171A] ">
									...
									<p className="text-[15px] text-[#649B9B]">
										We prioritize our clients and their unique needs. We listen
											...
											<div className="relative min-h-[700px] justify-evenly flex flex-col sm:p-8 p-3 gap-5 bg-gradient-to-bl from-[#00171A] to-transparent rounded-3xl border  border-[#00393D]">
												<div className="flex flex-col gap-5">
													...
													<p className="text-[#649B9B] text-[14px]">
														...
														blend creativity and technical finesse. Our projects
														cater to the dynamic needs of the Indian market.
													</p>
												</div>
											...
											<div className="relative min-h-[700px] justify-evenly flex flex-col sm:p-8 p-3 gap-5 bg-gradient-to-bl from-[#00171A] to-transparent rounded-3xl border  border-[#00393D]">
												<div className="flex flex-col gap-5">
													...
													<p className="text-[#649B9B] text-[14px]">
														...
														projects that blend technical expertise and creative
														solutions. Our projects cater to the dynamic needs
										...
										<ScrollAnimation variants={fadeInUp}>
											<div className="min-h-[650px] justify-evenly relative flex flex-col sm:p-8 p-3 gap-5 bg-gradient-to-bl from-[#00171A] to-transparent rounded-3xl border  border-[#00393D]">
												<div className="flex flex-col gap-5">
													...
													<p className="text-[#649B9B] text-[14px]">
														Explore a showcase of unique design projects that
														blend creativity and technical finesse. Lorem, ipsum
										...
										<ScrollAnimation variants={fadeInUp}>
											<div className="min-h-[700px] justify-evenly relative w-full flex flex-col sm:p-8 p-3 gap-5 bg-gradient-to-bl from-[#00171A] to-transparent rounded-3xl border  border-[#00393D]">
												<div className="flex flex-col gap-5">
													...
													<p className="text-[#649B9B] text-[14px]">
														Explore a showcase of innovative management projects
														that blend strategic planning and operational
														excellence. Our projects cater to the dynamic needs
														of the Indian market.
													</p>
												</div>
												<div className="w-full flex flex-wrap items-center  gap-3">
										...
										<ScrollAnimation variants={fadeInUp}>
											<div className="min-h-[700px] justify-evenly relative w-full flex flex-col sm:p-8 p-3  gap-5 bg-gradient-to-bl from-[#00171A] to-transparent rounded-3xl border  border-[#00393D]">
												<div className="flex flex-col gap-5">
													...
													<p className="text-[#649B9B] text-[14px]">
														Explore a showcase of innovative management projects
														that leverage technology and strategic insights. Our
														projects cater to the evolving needs of the Indian
														market.
													</p>
												</div>
												<div className="w-full flex items-center  flex-wrap gap-3">
				...
				<div className="pt-24 px-2 sm:px-8 w-full relative">
					<div className="w-full min-h-[400px] flex flex-col gap-5 py-8">
						<div className="w-[85%] mx-auto flex flex-col items-center gap-5">
							...
							<p className="text-[#507C7C] text-[16px] text-center">
								Dive into a collection of testimonials that speak to the impact
								of DevXplore. Our clients share their journey, highlighting the
							...
							<div className="max-w-[750px] min-h-[60px] p-5 border relative rounded-3xl gap-2 flex  border-[#002629] transition-all items-center">
								<div className="flex flex-col">
									...
									>
										...
										and usability testing to ensure an excellent user
										experience.
									</p>
								</div>
								<button
