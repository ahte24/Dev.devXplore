		...
		<div className="min-h-screen bg-[#000e0f] ">
			...
			<main className="container mx-auto space-y-14 p-4 mt-6 bg-[#000e0f] border-2 rounded-xl border-[#00484e] shadow-lg">
				...
				<section id="services">
					...
					<p className="text-[#5f9494]">
						DevXplore offers a range of services, including but not limited to:
					</p>
				...
				<section id="intellectual-property">
					...
					<p className="text-[#5f9494]">
						...
						limited to text, designs, graphics, and logos, are the property of
						DevXplore or its content suppliers. You may not reproduce,
						duplicate, copy, sell, resell, or exploit any portion of the website
				...
				<section id="limitation-of-liability">
					...
					<p className="text-[#5f9494]">
						DevXplore shall not be liable for any direct, indirect, incidental,
						special, or consequential damages resulting from the use or
						inability to use the website or services, including but not limited
				...
				<section id="indemnification">
					...
					<p className="text-[#5f9494]">
						You agree to indemnify and hold harmless DevXplore, its affiliates,
						officers, directors, employees, agents, and third parties from any
						claims, losses, liability, damages, and/or costs arising from your
						use of our website or breach of these Terms.
					</p>
				</section>
